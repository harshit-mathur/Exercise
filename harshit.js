...
function chk(){
    ...
    if(uname === ''){
        ...
        document.getElementById('check_uname').innerHTML = 'Enter Username !!!';
    }
    else{
        document.getElementById('check_uname').innerHTML = ''; 
    }

    if(pass === ''){
        event.preventDefault();
        document.getElementById('check_pass').innerHTML = 'Enter Password !!!'; 
    }
    else{
    ...
    if(cnf_pass === ''){
        event.preventDefault();
        document.getElementById('check_pass').innerHTML = 'Confirm Password !!!'; 
    }
